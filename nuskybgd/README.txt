...
This code is offered "as is" for the user. Users should be warned that using nuskbygd occasionally requires some tweaking of the scripts to work for specific cases.

Please also note that nuskbygd relies (heavily) on the AstroLib and is not intended as a standalone repository. Please check out the entire nustar-idl repo if you want to use nuskbygd.
